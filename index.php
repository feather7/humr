...
<form method="post">
    <div id="myDropdown" class="dropdown-content">
        <input id="strana_a" class="tlacitko"type="submit" value="A" name="strana_a">
        <input id="strana_an" class="tlacitko"type="submit" value="A - Zbývá" name="strana_an"><br>
        <input id="strana_b" class="tlacitko"type="submit" value="B" name="strana_b">
        <input id="strana_bn" class="tlacitko"type="submit" value="B - Zbývá" name="strana_bn"><br>
        <input id="strana_c" class="tlacitko"type="submit" value="C" name="strana_c">
        <input id="strana_cn" class="tlacitko"type="submit" value="C - Zbývá" name="strana_cn"><br>
        <input id="strana_u" class="tlacitko"type="submit" value="U" name="strana_u">
        <input id="strana_un" class="tlacitko"type="submit" value="U - Zbývá" name="strana_un"><br>
        <input id="strana_v" class="tlacitko"type="submit" value="V" name="strana_v">
        <input id="strana_vn" class="tlacitko"type="submit" value="V - Zbývá" name="strana_vn"><br>
        <input id="strana_w" class="tlacitko"type="submit" value="W" name="strana_w">
        <input id="strana_wn" class="tlacitko"type="submit" value="W - Zbývá" name="strana_wn"><br>
        <input id="bridge" class="tlacitko"type="submit" value="Bridge" name="bridge">
        <input id="bridge_n" class="tlacitko"type="submit" value="Bridge - Zbývá" name="bridge_n"><br>
        <input id="lanka" class="tlacitko" type="submit" value="Lanka" name="lanka">
        <input id="lanka_n" class="tlacitko" type="submit" value="Lanka - Zbývá" name="lanka_n"><br>
        <input id="kabely" class="tlacitko"type="submit" value="Kabely" name="kabely">
        <input id="kabely_n" class="tlacitko"type="submit" value="Kabely - Zbývá" name="kabely_n"><br>
        <input id="optiky" class="tlacitko"type="submit" value="Optiky" name="optiky">
        <input id="optiky_n" class="tlacitko"type="submit" value="Optiky - Zbývá" name="optiky_n"><br>
        <input id="ws0" class="tlacitko"type="submit" value="WS0" name="ws0">
        <input id="ws1" class="tlacitko"type="submit" value="WS1" name="ws1">
        <input id="ws2" class="tlacitko"type="submit" value="WS2" name="ws2">
        <input id="ws3" class="tlacitko"type="submit" value="WS3" name="ws3"><br>
        <input id="dvojdutinkyfrom" class="tlacitko"type="submit" value="Dvojdutinky From" name="dvojdutinkyfrom">
        <input id="vsechno" class="tlacitko"type="submit" value="Všechno" name="vsechno">
        <input id="zbyva" class="tlacitko"type="submit" value="Zbývá" name="zbyva">
        <input id="zmeny" class="tlacitko"type="submit" value="Změny" name="zmeny">
    </div> 
</form>
</div>
